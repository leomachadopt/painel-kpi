  ...
  const updateConsultationEntry = async (
    ...
    try {
      ...
      await dailyEntriesApi.consultation.update(clinicId, entryId, {
        ...
        consultationTypeId: updatedEntry.consultationTypeId || null,
        consultationCompleted: updatedEntry.consultationCompleted || false,
        consultationCompletedAt: updatedEntry.consultationCompletedAt || null,
        completedProcedures: updatedEntry.completedProcedures || null,
