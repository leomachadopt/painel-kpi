...
export const PERMISSION_PROFILES: PermissionProfile[] = [
  ...
  },
  {
    ...
    nameEn: 'Assistant',
    namePt: 'Assistente',
    description: 'Acesso a lançamentos clínicos e visualização geral',
    descriptionEn: 'Access to clinical entries and general viewing',
    descriptionPt: 'Acesso a lançamentos clínicos e visualização geral',
    permissions: {
      dashboard: 'view',
      inputs: 'view',
      reports: 'view',
