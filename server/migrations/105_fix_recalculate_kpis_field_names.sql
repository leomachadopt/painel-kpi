-- Migration 105: Fix recalculate_daily_kpis function field names
-- Fix function to use correct field names for each table
...
BEGIN
  ...
  -- daily_financial_entries uses 'date' not 'entry_date'
  ...
  -- daily_consultation_entries uses 'date' not 'entry_date'
  ...
  -- daily_prospecting_entries uses 'date' not 'entry_date'
  ...
  -- daily_service_time_entries uses 'date' not 'entry_date'
